...
export function isClusterOptions(options: any): options is RedisClusterConnectionOptions {
  return options && typeof options === 'object' && Array.isArray(options.nodes);
}

export function isStandaloneOptions(options: any): options is RedisStandaloneConnectionOptions {
