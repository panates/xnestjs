...
export class RabbitmqCoreModule implements OnApplicationShutdown, OnApplicationBootstrap {
  /**
   *
   */
          ...
          clients: [
            {
              ...
              useFactory: (connectionOptions: RabbitmqConnectionOptions): ClientProvider => {
                return {
